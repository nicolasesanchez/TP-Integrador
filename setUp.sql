...
create table OrdenTrabajo (ID int primary key not null, FechaInicio varchar(255) not null, FechaFin varchar(255), Estado varchar(255) not null, DNICliente int not null, DNIEmpleado int, CantidadHoras int, IDRepuestoUtilizado int, PatenteVehiculo varchar(255) not null)
