...
insert into master.dbo.Repuesto (Nombre, Precio) values ('Neumatico', 700)
insert into master.dbo.Repuesto (Nombre, Precio) values ('Bateria', 6789.29)
insert into master.dbo.Repuesto (Nombre, Precio) values ('Faro antiniebla', 1700)
insert into master.dbo.Repuesto (Nombre, Precio) values ('Carcaza filtro de aire', 1845.07)